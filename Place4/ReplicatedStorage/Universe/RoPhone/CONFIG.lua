...
-- UI defaults
CONFIG.ISLAND_MARGIN = .05                      -- Scape between top of screen and top of Island Bar in scale
CONFIG.ISLAND_SIZE = Vector2.new(0,0)           -- Size of the Island Bar in scale

CONFIG.GESTURE_MARGIN = .05                     -- Space between bottom of screen and bottom of Gesture Bar in scale
...
CONFIG.DOCK_MARGIN = .05                        -- Space between top of Gesture Bar and bottom of Dock
CONFIG.DOCK_SIZE = Vector2.new(0,0)             -- Size of the Dock on the homescreen
